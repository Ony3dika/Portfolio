  ...
  return (
    <React.Fragment>
      <div
        ...
        id='contact'
      >
        <p className='text-center lg:text-8xl mt-10 lg:mt-5 text-4xl font-extrabold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-icon via-sub about-text to-primaryDark pt-16'>
          CONTACT
        </p>
        ...
        <section className='flex lg:flex-row flex-col justify-between pb-12 mt-5'>
            ...
            <div className='w-full h-full'>
              <div className='md:pt-10 md:mx-12 p-5'>
                ...
                <p className='mt-5 text-white/80 text-base leading-loose'>
                  Feel free to reach out to me via email. You can also connect
                  with me on LinkedIn or follow me on Twitter for updates and
          ...
          {/* Form */}
          <div className='basis-6/6 lg:basis-3/6 lg:px-10  pt-5 rounded-xl'>
